...
void LibrarianLogin(Library &Time);
...
int main()
{
    ...
    {
        cout << "'" << student->get_username() << "'"
             << ";"
             << "'" << student->get_password() << "'" << endl;
    }
    ...
    string str = "20213687";
    Time.removeStudent(str);
    students = Time.getStudents();
    Time.updateStudent(students);
    ...
    string str1 = "20213666";
    Time.removeStudent(str1);
    students = Time.getStudents();
    Time.updateStudent(students);
    ...
    // cout << "Before login - Number of students: " << Time.getStudents().size() << endl;

    // Student *newStudent = nullptr;
    // StudentLogin(Time, newStudent);
    ...
    // //     }
    // // }
    // cout << "After login - Number of students: " << Time.getStudents().size() << endl;
    // vector<Student *> newstudents = Time.getStudents();
    // Time.updateStudent(newstudents);

    // int j = 1;
    // for (auto student : Time.getStudents())
    // {
    //     cout << j << ".";
    ...
    //     cout << student->get_borrowed_books() << endl;
    //     j++;
    // }
    ...
    //                     {
    //                         Time.readStudentFile(); //first, pass the value of the file to the vector
    //                         cout << "How many books do you want to borrow?(maximum is 3): ";
    //                         int num;
    //                         cin >> num;
    //                         cin.ignore();
    ...
    //                             }
    //                         }
    //                         Time.updateStudent(); //update the vector to the file
...
void LibrarianLogin(Library &Time)
{
    ...
    vector<Librarian *> librarians = Time.getLibrarians();
    for (auto librarian : librarians)
    {
        if (librarian->get_username() == username && librarian->get_password() == password)
        {
